  ...
  <div class="board-menu">
    ...
    <ul class="menu-list">
      ...
      <div class="color-picker">
        <a href="" data-value="rgb(0, 121, 191)" @click.prevent="onChagneTheme"></a>
        <a href="" data-value="rgb(210, 144, 52)" @click.prevent="onChagneTheme"></a>
        <a href="" data-value="rgb(81, 152, 57)" @click.prevent="onChagneTheme"></a>
        <a href="" data-value="rgb(176, 70, 50)" @click.prevent="onChagneTheme"></a>
      </div>
    </ul>
  </div>
</template>
